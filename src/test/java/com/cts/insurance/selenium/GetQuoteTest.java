...
public class GetQuoteTest {
	...
	public void coverageDetails() throws IOException {
		...
		// Check coverage information is correct
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[2]/td[2]")).getText(), containsString("$ 62.5"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[3]/td[2]")).getText(), containsString("$ 315000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[4]/td[2]")).getText(), containsString("$ 31500.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[5]/td[2]")).getText(), containsString("$ 189000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[6]/td[2]")).getText(), containsString("$ 63000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[7]/td[2]")).getText(), containsString("$ 5000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div[2]/table/tbody/tr[8]/td[2]")).getText(), containsString("$ 1500.0"));
		
		// Take screenshot
		takeScreenShot(driver);

		WebElement addInfo = driver.findElement(By.xpath("/html/body/div/div[1]/a"));
		addInfo.click();
		takeScreenShot(driver);
