...
public class RenewPolicyAsAdminTest {
	...
	@Test
	public void beginRenewPolicyTest() throws IOException {
		// Check redirected to correct page
		...
		// Click Renew button
		driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[8]/form/input")).click();
