...
public class MyPoliciesTest {
	...
	@Test
	public void beginMyPoliciesTest() throws IOException {
		// Clicking My Policy from navigation menu
		WebElement startBtn = driver.findElement(By.xpath("/html/body/header/nav/ul/li[4]/a"));
		startBtn.click();

		// Check redirected to correct page
		assertThat(driver.getTitle(), equalTo("Policy List"));
