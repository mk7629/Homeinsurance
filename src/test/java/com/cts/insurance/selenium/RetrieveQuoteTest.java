...
public class RetrieveQuoteTest {
	...
	@Test
	public void beginRetrieveQuoteTest() throws IOException {
		...
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[2]")).getText(),
				containsString("$ 62.5"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[3]")).getText(),
				containsString("$ 315000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[4]")).getText(),
				containsString("$ 31500.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[5]")).getText(),
				containsString("$ 189000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[6]")).getText(),
				containsString("$ 63000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[7]")).getText(),
				containsString("$ 5000.0"));
		assertThat(driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[8]")).getText(),
				containsString("$ 1500.0"));

		// Take screenshot
		takeScreenShot(driver);

		WebElement buyQuoteBtn = driver.findElement(By.xpath("/html/body/div/div/table/tbody/tr[5]/td[9]/form/input"));
		buyQuoteBtn.click();
		takeScreenShot(driver);
