...
public class Location {
	...
	public Location(int locationId, int userId, String residenceType, String addressLine1, String addressLine2,
	...
	public Location(int userId, String residenceType, String addressLine1, String addressLine2,
			String city, String locationState, String zipCode, String residenceUse) {
		this.userId = userId;
		this.residenceType = residenceType;
		this.addressLine1 = addressLine1;
